...
export const levelHelp: Record<number, LevelHelp> = {
  ...
  3: {
    ...
    content: "Проведіть детальний допит головних підозрюваних. Будьте уважні! Кожному підозрюваному можна задати по 4 питання. Задавайте ті питання які допоможуть визначити що приховує кожен з підозрюваних. "
  },
  4: {
    title: "",
    content: ""
